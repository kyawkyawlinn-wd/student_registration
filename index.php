  ...
  <nav class="navbar navbar-expand bg-dark navbar-dark">
     <div class="container py-3">
      ...
      <ul class="navbar-nav">
        ...
        <li class="navb-item"><a href="./register.php" class="nav-link">Register</a></li>
        <li class="nav-item"><a href="./view.php" class="nav-link">View</a></li>
        <li class="nav-item"><a href="./edit.php" class="nav-link">Update</a></li>
  ...
  <div class="container">
    <h1 class="text-center my-4">Student Registration</h1>
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card">
                       <img src="./img/class.jpg" alt="class" style="height: 500px;">
                    </div>
                </div>
            </div>
  </div>
  <footer class="bg-dark text-center text-light position-absolute w-100 bottom-0 p-3">
    Develope by intern batch 8
  </footer>
